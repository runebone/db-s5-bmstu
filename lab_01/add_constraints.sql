...
ALTER TABLE user.main
    ...
    FOREIGN KEY (pfp_id)
    REFERENCES file.main(id);

    ALTER COLUMN bio SET NULL,

ALTER TABLE user.post
    ALTER COLUMN id SET NOT NULL,
    ...
    FOREIGN KEY (user_id)
    REFERENCES user.main(id)
    ON DELETE CASCADE,

    ALTER COLUMN creation_date SET NOT NULL;

ALTER TABLE user.post_attachment
    ALTER COLUMN post_id SET NOT NULL,
    ADD CONSTRAINT fk_user_post_attachment_post_id
    FOREIGN KEY (post_id)
    REFERENCES user.post(id)
    ON DELETE CASCADE,
